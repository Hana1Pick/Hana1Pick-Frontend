...
function MoaclubDeposit() {
	...
	const handleAmountKRWChange = async () => {
        setIsLoading(true); // 로딩 상태 시작
        try {
            const response = await axios.get(
                `http://${process.env.REACT_APP_BESERVERURI}/api/exchange/calculate`,
                {
                    params: {
                        fromCurrency: "KRW",
    ...
    return (
        <>
            ...
            {!isLoading && (
                <div className='moaDepositAmountContainerFee'>
                    <div className='moaDepositAmountBox'>
                        <div className='moaDepositFixedBoxFee'>
                            <div className='moaDepositRow'>
                                <div className='moaDepositCountry'>적용 환율</div>
								{/* // TODO: api 호출 */}
                                <div className='moaDepositValue'>90% 우대 / 1,380.61원</div>
                            </div>
                            <div className='moaDepositRow'>
                                <div className='moaDepositCountry'>환율 수수료</div>
                                <div className='moaDepositValue'>217원</div>
                            </div>
                            <div className='moaDepositRow'>
                                <div className='moaDepositCountry'>결제금액</div>
                                <div className='moaDepositValue large'>13,806원</div>
                            </div>
                        </div>
                    </div>
                </div>

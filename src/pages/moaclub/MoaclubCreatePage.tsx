...
function MoaclubCreatePage() {
  ...
  const { setName, setCurrencyProvider, setClubFee, setAtDate }: any = useContext(MoaclubContext);
      ...
      <div>
        <div className="withdraw-box7" id="withdraw-box7">
          ...
          <div className="moaclub-box5">
            <CommonBtn type='pink' value="다음" onClick={nextNextNextStage} disabled={selectedDay === 0} />
          </div>
        ...
        <div className="withdraw-box4" id="withdraw-box8">
          <div className="moaclub-box6">
            ...
            <div className="clubFeeBox">
              ...
              <div className="picker">
                <input className="clubFeeText" type="" value={amount} onChange={handleAmountChange} placeholder="금액을 입력하세요." />
                <span className="currencySymbol">{getCurrencySymbol(currency)}</span>
              </div>
            </div>
          </div>
          <div className="moaclub-box5">
            <CommonBtn type='pink' value="완료" onClick={next} disabled={ amount === "" } />
          </div>
